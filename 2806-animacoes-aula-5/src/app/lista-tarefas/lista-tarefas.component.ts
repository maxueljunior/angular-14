...
import { checkButtonTrigger, filterTrigger, highlightedStateTrigger, shownStateTrigger, formButtonTrigger, naoHaTarefasTrigger,listStateTrigger, shakeTrigger} from '../animations';
